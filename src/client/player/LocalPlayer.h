...
private:
	...
	// Portal cooldown: when the player stands in a portal block, this counts
	// up each tick. When it reaches a threshold, a dimension swap fires. The
	// counter resets when the player leaves the portal or after the swap.
	int  portalCooldown;
public:
